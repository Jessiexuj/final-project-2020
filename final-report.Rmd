...
```{r}
layerContrib=merge(worldMap,Fdata, 
                   by.x='NAME_EN', 
                   by.y='Country',
                   all.x=F)
...
titlea = annotate_figure(layer1,
                            top = text_grob("Corruption World Map",
                                            face = "bold", size = 12),#add title to the top od the plot and adjust the font and size
                           bottom = text_grob("Data source: WGI group",
                                               hjust = 1, x = 1,
                                               face = "italic", 
                                               size = 10),#add data source to the bottom of the plot and adjust the font and size
                            left = NULL,
...
titleb = annotate_figure(layer2,
                            top = text_grob("Government Effectiveness World Map",
                                            face = "bold", size = 12),#add title to the top od the plot and adjust the font and size
                           bottom = text_grob("Data source: WGI group",
                                               hjust = 1, x = 1,
                                               face = "italic", 
...
titlec = annotate_figure(layer3,
                            top = text_grob("Political Stability World Map",
                                            face = "bold", size = 12),#add title to the top od the plot and adjust the font and size
                           bottom = text_grob("Data source: WGI group",
                                               hjust = 1, x = 1,
                                               face = "italic", 
...
titled = annotate_figure(layer4,
                            top = text_grob("Regulatory Quality World Map",
                                            face = "bold", size = 12),#add title to the top od the plot and adjust the font and size
                           bottom = text_grob("Data source: WGI group",
                                               hjust = 1, x = 1,
                                               face = "italic", 
...
titlee = annotate_figure(layer5,
                            top = text_grob("Rule of Law World Map",
                                            face = "bold", size = 12),#add title to the top od the plot and adjust the font and size
                           bottom = text_grob("Data source: WGI group",
                                               hjust = 1, x = 1,
                                               face = "italic", 
...
```{r}
layer6 = baseLayer + geom_sf(data = layerContrib,
                             aes(fill=cutMSTAB),
                             color=NA,show.legend = T) +
                 scale_fill_brewer(palette = colorForScale,
...
titlef = annotate_figure(layer6,
                            top = text_grob("Voice & Accountability World Map",
                                            face = "bold", size = 12),#add title to the top od the plot and adjust the font and size
                           bottom = text_grob("Data source: WGI group",
                                               hjust = 1, x = 1,
                                               face = "italic", 
